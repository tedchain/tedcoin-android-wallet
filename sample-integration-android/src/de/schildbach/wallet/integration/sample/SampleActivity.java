...
import de.schildbach.wallet.integration.android.TedcoinIntegration;
...
public class SampleActivity extends Activity
{
	...
	private void handleDonate()
	{
		...
		TedcoinIntegration.requestForResult(SampleActivity.this, REQUEST_CODE, addresses[0]);
	}
	...
	private void handleRequest()
	{
		try
		{
			...
			TedcoinIntegration.requestForResult(SampleActivity.this, REQUEST_CODE, paymentRequest.build().toByteArray());
		}
	...
	protected void onActivityResult(final int requestCode, final int resultCode, final Intent data)
	{
		if (requestCode == REQUEST_CODE)
		{
			...
			{
				final String txHash = TedcoinIntegration.transactionHashFromResult(data);
				if (txHash != null)
				{
					...
					if (TedcoinIntegration.paymentFromResult(data) != null)
