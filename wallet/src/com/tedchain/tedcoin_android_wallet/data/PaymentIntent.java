...
package com.tedchain.tedcoin_android_wallet.data;
...
import com.tedchain.tedcoinj.core.WrongNetworkException;
import com.tedchain.tedcoinj.script.Script;
import com.tedchain.tedcoinj.script.ScriptBuilder;
...
public final class PaymentIntent implements Parcelable
{
	...
	public static PaymentIntent fromtedcoinUri(@Nonnull final tedcoinURI tedcoinUri)
	{
		final Output[] outputs = buildSimplePayTo(tedcoinUri.getAmount(), tedcoinUri.getAddress());
		final String bluetoothMac = (String) tedcoinUri.getParameterByName(Bluetooth.MAC_URI_PARAM);

		return new PaymentIntent(PaymentIntent.Standard.BIP21, null, null, null, outputs, tedcoinUri.getLabel(), bluetoothMac != null ? "bt:"
				+ bluetoothMac : null, null, tedcoinUri.getPaymentRequestUrl());
	}
