...
package com.tedchain.tedcoin_android_wallet.offline;
...
import org.tedcoin.protocols.payments.Protos.PaymentACK;
...
public abstract class AcceptBluetoothThread extends Thread
{
	...
	protected static BluetoothServerSocket listen(final BluetoothAdapter adapter, final UUID uuid)
	{
		try
		{
			return adapter.listenUsingInsecureRfcommWithServiceRecord("tedcoin Transaction Submission", uuid);
		}
		catch (final IOException x)
		{
