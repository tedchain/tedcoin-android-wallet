...
package com.tedchain.tedcoin_android_wallet;
...
import com.tedchain.tedcoinj.params.MainNetParams;
...
public class Constants
{
	...
	public static final String EXTERNAL_WALLET_KEY_BACKUP = "tedcoin-wallet-keys";
	public static final String EXTERNAL_WALLET_BACKUP = "tedcoin-wallet-backup";
	...
	public static final String EXPLORE_BASE_URL = "https://www.tedcoinexplorer.info/";

	public static final String MIMETYPE_TRANSACTION = "application/x-ppctx";
	public static final String MIMETYPE_WALLET_BACKUP = "application/x-tedcoin-wallet-backup";

	public static final int MAX_NUM_CONFIRMATIONS = 7;
	public static final String USER_AGENT = "tedcoin Wallet";
	...
	public static final String REPORT_EMAIL = "tedchain@thelibertyportal.com";
	public static final String REPORT_SUBJECT_ISSUE = "Reported issue";
	public static final String REPORT_SUBJECT_CRASH = "Crash report";

	public static final String LICENSE_URL = "http://www.gnu.org/licenses/gpl-3.0.txt";
	public static final String SOURCE_URL = "https://github.com/MatthewLM/tedcoin-android-wallet";
	public static final String BINARY_URL = "https://github.com/MatthewLM/tedcoin-android-wallet/releases";
	public static final String CREDITS_tedcoinJ_URL = "https://github.com/MatthewLM/tedcoinj";
