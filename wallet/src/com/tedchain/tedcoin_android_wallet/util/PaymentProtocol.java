...
package com.tedchain.tedcoin_android_wallet.util;
...
import org.tedcoin.protocols.payments.Protos;

import com.tedchain.tedcoinj.core.Address;
import com.tedchain.tedcoinj.core.ScriptException;
import com.tedchain.tedcoinj.core.Transaction;
import com.tedchain.tedcoinj.protocols.payments.PaymentRequestException;
import com.tedchain.tedcoinj.protocols.payments.PaymentSession;
import com.tedchain.tedcoinj.protocols.payments.PaymentSession.PkiVerificationData;
...
{
	public static final String MIMETYPE_PAYMENTREQUEST = "application/tedcoin-paymentrequest"; // BIP 71
	public static final String MIMETYPE_PAYMENT = "application/tedcoin-payment"; // BIP 71
	public static final String MIMETYPE_PAYMENTACK = "application/tedcoin-paymentack"; // BIP 71
			...
			@Nullable final BigInteger refundAmount, @Nullable final String memo, @Nullable final byte[] merchantData)
	{
		...
		builder.addTransactions(ByteString.copyFrom(transaction.unsafetedcoinSerialize()));
