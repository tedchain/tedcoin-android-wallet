...
import com.tedchain.tedcoinj.core.TransactionInput;
import com.tedchain.tedcoinj.core.TransactionOutput;
...
public class WalletUtils
{
	...
	public static void writeKeys(@Nonnull final Writer out, @Nonnull final List<ECKey> keys) throws IOException
	{
		...
		out.write("# KEEP YOUR PRIVATE KEYS SAFE! Anyone who can read this can spend your tedcoins.\n");
