...
import org.tedcoin.protocols.payments.Protos.Payment;
...
import com.tedchain.tedcoinj.core.Sha256Hash;
import com.tedchain.tedcoinj.core.Transaction;
import com.tedchain.tedcoinj.core.TransactionConfidence;
import com.tedchain.tedcoinj.core.TransactionConfidence.ConfidenceType;
import com.tedchain.tedcoinj.core.Wallet;
import com.tedchain.tedcoinj.core.Wallet.BalanceType;
import com.tedchain.tedcoinj.core.Wallet.SendRequest;

import com.tedchain.tedcoin_android_wallet.AddressBookProvider;
import com.tedchain.tedcoin_android_wallet.Configuration;
import com.tedchain.tedcoin_android_wallet.Constants;
import com.tedchain.tedcoin_android_wallet.ExchangeRatesProvider;
import com.tedchain.tedcoin_android_wallet.ExchangeRatesProvider.ExchangeRate;
...
import com.tedchain.tedcoin_android_wallet.data.PaymentIntent.Standard;
import com.tedchain.tedcoin_android_wallet.integration.android.tedcoinIntegration;
import com.tedchain.tedcoin_android_wallet.offline.DirectPaymentTask;
import com.tedchain.tedcoin_android_wallet.ui.InputParser.BinaryInputParser;
import com.tedchain.tedcoin_android_wallet.ui.InputParser.StreamInputParser;
import com.tedchain.tedcoin_android_wallet.ui.InputParser.StringInputParser;
import com.tedchain.tedcoin_android_wallet.util.Bluetooth;
import com.tedchain.tedcoin_android_wallet.util.GenericUtils;
...
public final class SendCoinsFragment extends SherlockFragment
{
	...
	public void onCreate(final Bundle savedInstanceState)
	{
		...
		else
		{
			...
			{
				initStateFromtedcoinUri(intentUri);
			}
			...
			{
				final byte[] paymentRequest = tedcoinIntegration.paymentRequestFromIntent(intent);
		...
		new SendCoinsOfflineTask(wallet, backgroundHandler)
		{
			...
			protected void onSuccess(final Transaction transaction)
			{
				...
				if (callingActivity != null)
				{
					...
					tedcoinIntegration.transactionHashToResult(result, sentTransaction.getHashAsString());
					if (paymentIntent.standard == Standard.BIP70)
						tedcoinIntegration.paymentToResult(result, payment.toByteArray());
	...
	private void initStateFromtedcoinUri(@Nonnull final Uri tedcoinUri)
	{
		final String input = tedcoinUri.toString();
	...
	private void initStateFromIntentUri(@Nonnull final String mimeType, @Nonnull final Uri tedcoinUri)
	{
		try
		{
			final InputStream is = contentResolver.openInputStream(tedcoinUri);
