...
public final class AboutActivity extends SherlockPreferenceActivity
{
	...
	private static final String KEY_ABOUT_CREDITS_tedcoinJ = "about_credits_tedcoinj";
	...
	protected void onCreate(final Bundle savedInstanceState)
	{
		...
		findPreference(KEY_ABOUT_CREDITS_tedcoinJ).setTitle(getString(R.string.about_credits_tedcoinj_title, VersionMessage.tedcoinJ_VERSION));
		findPreference(KEY_ABOUT_CREDITS_tedcoinJ).setSummary(Constants.CREDITS_tedcoinJ_URL);
	...
	public boolean onPreferenceTreeClick(final PreferenceScreen preferenceScreen, final Preference preference)
	{
		...
		else if (KEY_ABOUT_CREDITS_tedcoinJ.equals(key))
		{
			startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(Constants.CREDITS_tedcoinJ_URL)));
			finish();
		}
